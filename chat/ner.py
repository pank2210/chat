...
class NERModel:
  ...
  def printPrediction(self,data_only=False):
    ...
    if data_only:
      ...
      print(" {} total size & {} errors Accuracy: {}".format(rec,rec_diff,self.rec_accu)) 
  ...
  def buildSentTestData(self,testfl):
    ...
    self.testX = util.getTokenizeSent(self.test_data_file,self.config.window)
...
if __name__ == "__main__":
  ...
  #nerModel.processRawDataRec("fail28rec.txt")
